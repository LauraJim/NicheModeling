...
Directly apply the accumulation curve. For this the the parameters `names`, `G.occ`, and `suit.Estck` are necessary (the latter two have already been prepared).
```{r}
...
Apply the function for the Mahalanobis distance model.
```{r}
...
Apply the function for the weighted normal distribution model.
```{r}
