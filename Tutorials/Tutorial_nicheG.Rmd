...
occ1 <- read.csv("./Generated_Data/Catasticta_nimbice_occ_GE.csv",header=T)
occ2 <- occ1[,-(1:2)]
```
\
...
Write the raster with the model as file (additionally, the cropped environmental layers can be saved as well for later use). 
```{r, eval=FALSE}
