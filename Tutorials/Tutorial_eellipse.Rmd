...
```{r pressure, echo=FALSE, fig.cap="A Statistical Methods for Evaluating Relationships. University of Kansas Science Bulletin, 38, 1409-1448.", out.width = '50%',fig.align="center"}
knitr::include_graphics("CitationSokalMichener.png")
```
\
\
