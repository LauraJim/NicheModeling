...
```{r, fig.show='hide', message=FALSE, warning=FALSE, cache=TRUE}
...
png(filename = "./Images/Thr_Iterations_abline.png",width = 2300, height = 2300, 
    res = 600, pointsize = 6)
# x11()
...
dev.off()
```
```{r, echo=FALSE, fig.cap=" Figure of the Bayesian iterations for the species *Threnetes ruckeri* marked with the lower limit.", out.width = '80%',fig.align="center"}
options(knitr.duplicate.label = "allow")
knitr::include_graphics("Images/Thr_Iterations_abline.png")
```
\
...
# x11()
png(filename = "./Images/Thr_MCMC_ellipses.png",width = 2300, height = 2300, 
    res = 600, pointsize = 6)
