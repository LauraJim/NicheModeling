...
Additionally, note that you can use this code to crop and mask any raster layer to the study area of each species. This is somethign you will need to do before doing some future examples. 