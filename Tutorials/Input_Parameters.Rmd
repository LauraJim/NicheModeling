...
```{r, echo=FALSE, fig.cap="Figure of the of the total annual precipitation (in ml) for the American continent.", out.width = '90%',fig.align="center"}
options(knitr.duplicate.label = "allow")
knitr::include_graphics("Images/Raster_bio12.png")
```
\
