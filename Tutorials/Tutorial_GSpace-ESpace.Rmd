...
species <- read.csv("./Input_Data/Catasticta_nimbice_occ_GE.csv",header=T)
...
ranpoints <- read.csv("./Input_Data/Catasticta_nimbice_M_GE.csv",header=T)
...
ranpoints2 <- read.csv("./Input_Data/Threnetes_ruckeri_M_GE.csv",header=T)
species2 <- read.csv("./Input_Data/Threnetes_ruckeri_occ_GE.csv",header=T)
