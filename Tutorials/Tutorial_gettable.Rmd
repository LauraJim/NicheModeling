...
* `G.occ` = a matrix with three columns, where the second and third column contain the coordinates in longitude and latitude
\
...
The observation information of a species does not need any modification and can be directly used from the folder *Initial_Data*.
\
