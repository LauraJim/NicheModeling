...
Three types of files are needed to reproduce the ecological niche modeling exercises included in this tutorial:
...
```{r pcks, echo=FALSE, warning=FALSE, message=FALSE}
library(raster)
library(sp)
library(ggplot2)
