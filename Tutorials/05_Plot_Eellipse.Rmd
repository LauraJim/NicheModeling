...
## Plotting ellipses that define the border of a suitable environment
...
[How to setup opengl on mingw w64 in Windows 10] (https://medium.com/@bhargav.chippada/how-to-setup-opengl-on-mingw-w64-in-windows-10-64-bits-b77f350cea7e).
\
\
...
```{r, echo=FALSE, fig.cap=" Figure of the three dimensional environmental space of *Catasticta nimbice* bordered by an ellipse shaped sphere.", out.width = '60%',fig.align="center"}
